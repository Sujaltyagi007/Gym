  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 uppercase tracking-wider",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-bg text-primary-foreground font-bold shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 hover:scale-105 active:scale-100 rounded-xl",
        heroOutline: "border-2 border-foreground/20 bg-transparent text-foreground backdrop-blur-sm hover:border-primary hover:text-primary hover:bg-foreground/5 rounded-xl",
        glow: "gradient-bg text-primary-foreground font-bold animate-pulse-glow hover:scale-105 active:scale-100 rounded-xl",
      },
      size: {
